...
Добро пожаловать в документацию проекта **jp-song-trainer**! Этот документ содержит все артефакты проекта: спецификации, пользовательские истории, диаграммы и API-контракты.
